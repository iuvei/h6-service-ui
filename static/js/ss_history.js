...
function updateHistoryData(){
	...
	for(var i = 0; i < historyData.records.length; i++){
		...
		html += '<tr>'
				...
				+ '<td class="numBallCell"><div class="' + (numArr[0] && ballInfoObj[numArr[0]].color) + 'Ball">' + numArr[0] + '</div></td>'
				+ '<td class="numAnimalCell">' + infoArr[0] + '</td>';
		if(numArr.length > 1)
			html += '<td class="numBallCell"><div class="' + (numArr[1] && ballInfoObj[numArr[1]].color) + 'Ball">' + numArr[1] + '</div></td>'
					+ '<td class="numAnimalCell">' + infoArr[1] + '</td>';
		else
			html += '<td class="numBallCell"></td>'
					+ '<td class="numAnimalCell"></td>';
		if(numArr.length > 2)
			html += '<td class="numBallCell"><div class="' + (numArr[2] && ballInfoObj[numArr[2]].color) + 'Ball">' + numArr[2] + '</div></td>'
					+ '<td class="numAnimalCell">' + infoArr[2] + '</td>';
		else
			html += '<td class="numBallCell"></td>'
					+ '<td class="numAnimalCell"></td>';
		if(numArr.length > 3)
			html += '<td class="numBallCell"><div class="' + (numArr[3] && ballInfoObj[numArr[3]].color) + 'Ball">' + numArr[3] + '</div></td>'
					+ '<td class="numAnimalCell">' + infoArr[3] + '</td>';
		else
			html += '<td class="numBallCell"></td>'
					+ '<td class="numAnimalCell"></td>';
		if(numArr.length > 4)
			html += '<td class="numBallCell"><div class="' + (numArr[4] && ballInfoObj[numArr[4]].color) + 'Ball">' + numArr[4] + '</div></td>'
					+ '<td class="numAnimalCell">' + infoArr[4] + '</td>';
		else
			html += '<td class="numBallCell"></td>'
					+ '<td class="numAnimalCell"></td>';
		if(numArr.length > 5)
			html += '<td class="numBallCell"><div class="' + (numArr[5] && ballInfoObj[numArr[5]].color) + 'Ball">' + numArr[5] + '</div></td>'
		...
		if(numArr.length > 6)
			html += '<td class="specialNumCell"><div class="' + (numArr[6] && ballInfoObj[numArr[6]].color) + 'Ball">' + numArr[6] + '</div></td>'
